...
/**
 * AppConfig: Configuración de INFRAESTRUCTURA y TIEMPOS.
 *
 * REVERSIÓN 3.1: Los tiempos de aviso/bloqueo y modo estricto vuelven aquí.
 * db.properties es la fuente de verdad para configuración técnica.
 * config.json (vía JsonConfigAdapter / ConfiguracionPort) es la fuente
 * de verdad para listas negra/blanca y URLs negras (dominio declarativo).
 *
 * SEPARACIÓN DE RESPONSABILIDADES:
 * - AppConfig: tiempos, modo, DB, paths (infraestructura técnica)
 * - ConfiguracionPort: listas de apps/URLs (dominio declarativo)
 */
public class AppConfig {
    ...
    // ============================================
    // TIEMPOS DE NIVELES (infraestructura técnica)
    // ============================================
